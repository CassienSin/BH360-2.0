      ...
      <section className="pt-32 pb-32 relative overflow-hidden bg-brand">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="mt-20 relative fade-up-4 px-4 sm:px-0" style={{maxWidth: '900px', margin: '5rem auto 0'}}>
              ...
              <div className="p-6 bg-white">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-5">
                  {[
                    ...
                    <div key={i} className="rounded-2xl p-3 border" style={{borderColor: '#f0effe'}}>
                ...
                <div className="space-y-2">
                  {[
                    { title: 'Streetlight broken — Sitio 3', status: 'pending', color: 'amber' },
                    { title: 'Noise complaint — Block 5', status: 'assigned', color: 'blue' },
                    { title: 'Flooding report — Riverside', status: 'resolved', color: 'emerald' },
                  ].map((inc, i) => (
                    <div key={i} className="flex items-center gap-3 px-3 py-2.5 rounded-xl border" style={{borderColor: '#f0effe'}}>
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full font-semibold bg-${inc.color}-100 text-${inc.color}-700`}>{inc.status}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Floating badges */}
            <div className="absolute -top-4 -left-4 px-4 py-2 rounded-2xl flex items-center gap-2 hidden sm:flex"
            ...
            <div className="absolute -bottom-4 -right-4 px-4 py-2 rounded-2xl flex items-center gap-2 hidden sm:flex"
              ...
              <div className="w-10 h-10 rounded-2xl mx-auto mb-3 flex items-center justify-center">
                <Image src="/logo.png" alt="AI Powered" width={24} height={24} className="object-contain" />
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={role} className={`p-7 rounded-3xl transition-all hover:scale-105 relative ${featured ? 'ring-2' : ''}`}
                ...
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mb-5" style={{background: bg}}>
                  {emoji}
                </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {testimonials.map((t, i) => (
              <div key={i} className="p-6 rounded-3xl transition-all hover:scale-105"
                style={{background: '#fafaff', border: '1px solid #f0effe'}}>
